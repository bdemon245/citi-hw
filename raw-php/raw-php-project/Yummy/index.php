    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="backend/login.php">Log in / Signup</a></li>
        </ul>
      </nav>
      <!-- .navbar -->
          ...
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              ...
              <div class="position-relative mt-4">
                <img src="./frontend/assets/img/about-2.jpg" class="img-fluid" alt="" />
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <div class="row gy-5">
              <div class="col-lg-4 menu-item">
                <a href="./frontend/assets/img/menu/menu-item-1.png" class="glightbox"><img src="./frontend/assets/img/menu/menu-item-1.png" class="menu-img img-fluid" alt="" /></a>
                <h4>Magnam Tiste</h4>
                <p class="ingredients">
              ...
              <div class="col-lg-4 menu-item">
                <a href="./frontend/assets/img/menu/menu-item-2.png" class="glightbox"><img src="./frontend/assets/img/menu/menu-item-2.png" class="menu-img img-fluid" alt="" /></a>
                <h4>Aut Luia</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="./frontend/assets/img/menu/menu-item-3.png" class="glightbox"><img src="./frontend/assets/img/menu/menu-item-3.png" class="menu-img img-fluid" alt="" /></a>
                <h4>Est Eligendi</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="./frontend/assets/img/menu/menu-item-4.png" class="glightbox"><img src="./frontend/assets/img/menu/menu-item-4.png" class="menu-img img-fluid" alt="" /></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="./frontend/assets/img/menu/menu-item-5.png" class="glightbox"><img src="./frontend/assets/img/menu/menu-item-5.png" class="menu-img img-fluid" alt="" /></a>
                <h4>Eos Luibusdam</h4>
                <p class="ingredients">
                  Lorem, deren, trataro, filede, nerada
                </p>
              ...
              <div class="col-lg-4 menu-item">
                <a href="./frontend/assets/img/menu/menu-item-6.png" class="glightbox"><img src="./frontend/assets/img/menu/menu-item-6.png" class="menu-img img-fluid" alt="" /></a>
              ...
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="./frontend/assets/img/testimonials/testimonials-1.jpg" class="img-fluid testimonial-img" alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="./frontend/assets/img/testimonials/testimonials-2.jpg" class="img-fluid testimonial-img" alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="./frontend/assets/img/testimonials/testimonials-3.jpg" class="img-fluid testimonial-img" alt="" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="./frontend/assets/img/testimonials/testimonials-4.jpg" class="img-fluid testimonial-img" alt="" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="gallery-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-1.jpg"><img src="./frontend/assets/img/gallery/gallery-1.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-2.jpg"><img src="./frontend/assets/img/gallery/gallery-2.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-3.jpg"><img src="./frontend/assets/img/gallery/gallery-3.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-4.jpg"><img src="./frontend/assets/img/gallery/gallery-4.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-5.jpg"><img src="./frontend/assets/img/gallery/gallery-5.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-6.jpg"><img src="./frontend/assets/img/gallery/gallery-6.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-7.jpg"><img src="./frontend/assets/img/gallery/gallery-7.jpg" class="img-fluid" alt="" /></a>
            </div>
            <div class="swiper-slide">
              <a class="glightbox" data-gallery="images-gallery" href="./frontend/assets/img/gallery/gallery-8.jpg"><img src="./frontend/assets/img/gallery/gallery-8.jpg" class="img-fluid" alt="" /></a>
            </div>
          </div>
          <div class="swiper-pagination"></div>
        </div>
