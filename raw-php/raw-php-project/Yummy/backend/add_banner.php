...
<div class="container p-3">
    <div class="card">
        <div class="card-title">
            <div class="bg-primary text-light text-center p-3 bold h4 rounded-top ">Add Banner</div>
        </div>
        <div class="card-body">
            <form class="form-floating" action="./controller/user_add_banner.php" method="POST" enctype="multipart/form-data">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control <?php is_invalid($error_title) ?>" id="banner_title" name="banner_title" placeholder="Your banner title" value="">
                            <label for="banner_title" class="text-secondary"><?php set_error($error_title, $label_title) ?></label>
                        </div>

                        <div class="form-floating mt-3">
                            <textarea class="form-control <?php is_invalid($error_detail) ?>" placeholder="Type your messege here..." id="banner_detail" name="banner_detail" style="min-height: 8rem;"></textarea>
                            <label for="banner_detail" class="text-secondary"><?php set_error($error_detail, $label_detail) ?></label>
                        </div>
                        <div class="form-floating mt-3">
                            <input type="url" class="form-control <?php is_invalid($error_video) ?>" id="floatingInputValue" placeholder="https://www.youtube.com/watch?v=id" value="" name="promo_video">
