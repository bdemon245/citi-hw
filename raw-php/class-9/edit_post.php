...
$request = isset($data) ? $data : null;
$author_email = isset($request['author_email']) ? $request['author_email'] : null;
$post_title = isset($request['post_title']) ? $request['post_title'] : null;
$post_detail  = isset($request['post_detail']) ? $request['post_detail'] : null;
$post_author  = isset($request['author_name']) ? $request['author_name'] : null;
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav flex-grow-1">
                    <a class="nav-link active ms-auto" aria-current="page" href="./edit_post.php">Edit Post</a>
    ...
    <main>
        <div class="container bg-light">
            <div class="card bg-light text-center py-3">
                <div class="card-title bg-light">Edit your Post</div>
                <div class="card-body bg-light">
                    <form action="./controller/update.php?id=<?= $id?>" method="post" class="container-sm justify-content-center
                    px-5
                    flex-column">
                        ...
                        <div class="d-flex flex-column align-items-start mt-3">
                            ...
                            <?= $not_verified ?>
                            <button type="submit" class="btn btn-primary d-inline-block mt-3" name="update" value="updated">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
